                ...
                <div class="col-12">
                    <div class="card m-b-20">
                        <div class="card-body">
                            ...
                            <form action="{{ route('wild_life_safari.update', $wildlifeSafari->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-4">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" value="{{ old('national_park', $wildlifeSafari->national_park) }}" id="name" name="national_park" placeholder="Enter National Park" required>
...
<script>
    $(document).ready(function() {
        ...
        function loadCities(stateId, selectedCity = null) {
            if (stateId) {
                $.ajax({
                    url: '/booking_portal/public/admin/safari/cities/' + stateId,
                    method: 'GET',
