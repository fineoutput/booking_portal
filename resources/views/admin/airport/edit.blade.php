                ...
                <div class="col-12">
                    <div class="card m-b-20">
                        <div class="card-body">
                            ...
                            <form action="{{ route('airport.update', $wildlifeSafari->id) }}" method="post" enctype="multipart/form-data">
    @csrf
    @method('PUT') <!-- This is used for sending a PUT request to update the resource -->
    ...
    <div class="form-group row">
        <div class="col-sm-4">
            <div class="form-floating">
                ...
                <label for="airport">Enter Airport &nbsp;<span style="color:red;">*</span></label>
            </div>
            @error('airport')
