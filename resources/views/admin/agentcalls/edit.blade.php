                ...
                <div class="col-12">
                    <div class="card m-b-20">
                        <div class="card-body">
                            ...
                            <form action="{{ route('AgentCalls.update', $agent->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT') <!-- This indicates that the form is for updating an existing resource -->
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <select class="form-control" id="state" name="state">
                                            @foreach ($states as $state)
                                                <option value="{{ $state->id }}" {{ old('state', isset($agent) ? $agent->state : null) == $state->id ? 'selected' : '' }}>
                                                    {{ $state->state_name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-floating">
                                            <input class="form-control" type="text" value="{{ old('remarks', $agent->remarks) }}" id="remarks" name="remarks" placeholder="Enter remarks" required>
