    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="page-title-box">
          <h4 class="page-title">View Hotels Calls</h4>
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javascript:void(0);">Hotels Calls</a></li>
            <li class="breadcrumb-item active">View Hotels Calls</li>
          </ol>
        </div>
      </div>
    </div>
        ...
        <div class="col-12">
          <div class="card m-b-20">
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-md-10">
                  <h4 class="mt-0 header-title">View Hotels Calls List</h4>
                </div>
                <div class="col-md-2"> <a class="btn btn-info cticket" href="{{route('add_hotelsCalls')}}" role="button" style="margin-left: 20px;"> Add Hotels Calls</a></div>
              </div>
                  ...
                  <table id="userTable" class="table  table-striped">
                    ...
                    <thead>
                      <tr>
                        ...
                        <th data-priority="3">Contact Person Name</th>
                        <th data-priority="1">Room Details</th>
                        <th data-priority="3">Cost Of Rooms</th>
