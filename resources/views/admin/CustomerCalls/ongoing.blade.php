    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="page-title-box">
          <h4 class="page-title">View Ongoing Customer Calls</h4>
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javascript:void(0);">Ongoing Customer Calls</a></li>
            <li class="breadcrumb-item active">View Ongoing Customer Calls</li>
          </ol>
        </div>
      </div>
    </div>
        ...
        <div class="col-12">
          <div class="card m-b-20">
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-md-10">
                  <h4 class="mt-0 header-title">View Ongoing Customer Calls List</h4>
                </div>
