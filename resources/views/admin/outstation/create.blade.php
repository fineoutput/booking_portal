                ...
                <div class="col-12">
                    <div class="card m-b-20">
                        <div class="card-body">
                            ...
                            <form action="{{route('outstation_create')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" type="text" value="" id="cost" name="cost" placeholder="Enter name" required>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" type="text" value="" id="drop_point" name="drop_point" placeholder="Enter name" required>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" type="text" value="" id="available_km" name="available_km" placeholder="Enter name" required>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" type="text" value="" id="extra_km_charge" name="extra_km_charge" placeholder="Enter name" required>
