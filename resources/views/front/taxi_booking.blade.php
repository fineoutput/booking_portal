...
<style>
 ...
 <picture>
  ...
  <form>
    ...
    <div class="mb-3">
  <label for="vehicle1" class="form-label">Select Vehicle</label>
  <input type="text" id="car-input1" class="form-control car-input" placeholder="Select a vehicle" readonly data-bs-toggle="modal" data-bs-target="#carmodal1">
</div>
