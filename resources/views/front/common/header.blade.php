...
<head>
  ...
  <meta name="google-site-verification" content="KKyYNGQg2azoQjol0DnJtMVkuQws_4dx6fDmSN8dOFA" />
        ...
        <div class="mmt-row">
            ...
            <div class='kya_kiya'>
                <a href="{{ route('user_profile') }}?tab=wallet" class="mmt-title dropdown-item">
                    My Wallet 
                    @if(isset($wallet))
                    <span class="mmt-wallet">₹{{ $wallet->balance ?? '0' }}</span>
                    @endif
                </a>
...
<nav class="navbar navbar-expand-lg navbar-dark nave_color ">
  <div class="container justify-content-center ">
    ...
    <a class="navbar-brand" style="visibility: hidden" href="{{ route('index') }}">Tours Dekho</a>
