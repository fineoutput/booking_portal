...
// Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::post('calculate-price', [HotelController::class, 'hotelBookingPreview']);
    ...
    Route::post('/hotel-preference', [HotelController::class, 'hotel_preference']);;
    Route::get('/hotel-profile', [HotelController::class, 'profile_hotel']);
...
Route::post('/wallet/add', [AuthController::class, 'add_wallet_api']);
Route::post('/wallet/razorpay/callback', [AuthController::class, 'walletRazorpayCallback']);
